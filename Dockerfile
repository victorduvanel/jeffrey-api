...
RUN curl -OL https://jffr.ams3.digitaloceanspaces.com/static/node-v11.9.0-linux-x64.tar.xz
RUN tar -xJf node-v11.9.0-linux-x64.tar.xz --strip-components=1 -C /usr/local
RUN rm node-v11.9.0-linux-x64.tar.xz
